...
const Account = () => {
  ...
  const changedata = async () => {
    ...
    if (newfname == "") {
      var newFirstName = userdata?.fname
    } else {
      var newFirstName = newfname
    }

    if (newlname == "") {
      var newLastName = userdata?.lname
    } else {
      var newLastName = newlname
    }

    if (newphone == "") {
      var newPhoneNum = userdata?.phone
    } else {
      var newPhoneNum = newphone
    }
